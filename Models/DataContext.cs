    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Urun>().HasData(
            new List<Urun>()
            {
                ...
                new Urun() { Id = 5, UrunAdi="Apple Watch 11", Fiyat=50000, Aktif=true, Resim="5.jpeg", Anasayfa=false,Aciklama="Lorem ipsum dolor sit amet."},
                new Urun() { Id = 6, UrunAdi="Apple Watch 12", Fiyat=60000, Aktif=true, Resim="6.jpeg", Anasayfa=false,Aciklama="Lorem ipsum dolor sit amet."},
            }
        );
    }
}
